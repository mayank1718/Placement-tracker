...
const Summary = () => {
  ...
  return (
    <div className="flex flex-col gap-5 border-2 border-gray-300 rounded-xl px-3 py-4 lg:m-0 mt-2 mb-2">
      <h2 className="font-bold font-sans text-2xl">Status Summary</h2>
      <div className="flex flex-col gap-2">
        <h3 className="font-bold flex gap-2 items-center text-xl text-gray-700 font-sans">
          <RiCircleFill size={16} color="rgba(80,198,13,1)" />{" "}
          Applied................... <span> {appliedCompany} </span>
        </h3>{" "}
        <h3 className="font-bold flex gap-2 items-center text-xl text-gray-700 font-sans">
          <RiCircleFill size={16} color="rgba(234,70,46,1)" /> OA
          Cleared................... <span> {oaClearedCompany} </span>
        </h3>{" "}
        <h3 className="font-bold flex gap-1 items-center text-xl text-gray-700 font-sans">
